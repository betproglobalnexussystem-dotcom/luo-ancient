...
export default function ProductPage() {
  ...
  const product = {
    ...
    description:
      "Elegant white leather sandals from Chanel featuring the iconic CC logo in gold. These sandals combine luxury and comfort with their premium leather construction and cushioned footbed. Perfect for elevating any summer outfit with a touch of designer elegance.",
              ...
              <div className="glass dark:glass-dark rounded-xl p-6">
                <nav className="mb-4">
                  <ol className="flex text-sm">
                    ...
                    <li className="text-muted-foreground">
                      <Link href="/luxury" className="hover:text-primary">
                        Luxury Collection
                      </Link>
                    </li>
                    <li className="mx-2 text-muted-foreground">/</li>
