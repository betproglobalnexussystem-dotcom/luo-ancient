...
export default function ProductPage() {
  ...
  const product = {
    ...
    description:
      "Make a bold statement with this vibrant, colorful printed kaftan. This eye-catching piece features a stunning mix of colors in an abstract pattern that's sure to turn heads. The loose, flowing design offers both comfort and style, making it perfect for various occasions from casual outings to special events.",
