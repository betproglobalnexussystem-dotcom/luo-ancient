...
export default function ProductPage() {
  ...
  const product = {
    ...
    description:
      "Elevate your wardrobe with this stunning green pleated maxi dress from YLD Textile. This elegant floor-length dress features beautiful pleating throughout and delicate lace detailing at the shoulders and sleeves. The vibrant green color makes a bold statement while the comfortable, flowing design ensures you'll feel as good as you look.",
    sizes: ["M", "L", "XL", "XXL"],
    colors: ["Green"],
    rating: 4.9,
    reviewCount: 32,
                ...
                <Tabs defaultValue="description">
                  ...
                  <TabsContent value="description" className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 mt-4 space-y-1">
                      ...
                      <li>Elegant pleated design</li>
                      <li>Delicate lace detailing on shoulders and sleeves</li>
                      <li>Premium quality fabric</li>
                      <li>Floor-length maxi style</li>
                      <li>Comfortable fit for all-day wear</li>
                      <li>Perfect for special occasions and formal events</li>
                    </ul>
                  </TabsContent>
