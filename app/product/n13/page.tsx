...
export default function ProductPage() {
  ...
  const product = {
    ...
    description:
      "This elegant green button-front dress combines sophistication with comfort. Featuring a flattering A-line silhouette, decorative buttons down the front, and beautiful floral pattern sleeves, this dress is perfect for both office wear and special occasions. The matching belt accentuates your waist for a polished, put-together look.",
    sizes: ["M", "L", "XL", "XXL"],
    colors: ["Green"],
    rating: 4.7,
    reviewCount: 28,
                ...
                <Tabs defaultValue="description">
                  ...
                  <TabsContent value="description" className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 mt-4 space-y-1">
                      ...
                      <li>Floral pattern sleeves</li>
                      <li>Matching belt included</li>
                      <li>A-line silhouette</li>
                      <li>Knee-length</li>
                      <li>High-quality fabric</li>
                      <li>Suitable for office wear and special occasions</li>
                    </ul>
                  </TabsContent>
