...
export default function ProductPage() {
  ...
  const product = {
    id: "n14",
    name: "Vibrant Multicolor Maxi Dress",
    price: 320000,
    image: "/images/vibrant-maxi-dress.png",
    category: "Women's Dresses",
    productCode: "VMMD-2023",
    description:
      "Make a bold fashion statement with this stunning vibrant multicolor maxi dress. Featuring eye-catching pink, blue, and green hues in a beautiful abstract pattern, this dress is designed to turn heads. The elegant ruffled collar and flowing silhouette create a flattering look, while the gold belt cinches the waist for a defined silhouette. Perfect for special occasions, parties, or whenever you want to make an impression.",
    sizes: ["44", "46"],
    colors: ["Multicolor"],
    rating: 4.9,
    reviewCount: 36,
                ...
                <Tabs defaultValue="description">
                  ...
                  <TabsContent value="description" className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 mt-4 space-y-1">
                      <li>Vibrant multicolored design with pink, blue, and green hues</li>
                      <li>Elegant ruffled collar detail</li>
                      <li>Long sleeves with elastic cuffs</li>
                      <li>Gold-tone belt included</li>
                      <li>High-quality chiffon fabric</li>
                      <li>Fully lined for comfort</li>
                      <li>Floor-length maxi style</li>
