...
export default function ProductPage() {
  ...
  const product = {
    ...
    price: 235000,
    image: "/images/navy-pattern-dress-belt.png",
    category: "Women's Dresses",
    productCode: "NWPD-2023",
    description:
      "This elegant navy and white patterned dress combines sophistication with modern style. Featuring a flattering silhouette with a striking navy and white swirl pattern, sheer navy sleeves, and a coordinating belt, this dress is perfect for both office wear and special occasions. The knee-length cut and comfortable fit make it a versatile addition to your wardrobe.",
    sizes: ["52", "56"],
    colors: ["Navy/White"],
    rating: 4.8,
    reviewCount: 26,
  ...
  const relatedProducts = [
    {
      ...
      price: 245000,
      image: "/images/green-button-dress.png",
      category: "Women's Dresses",
                ...
                <Tabs defaultValue="description">
                  ...
                  <TabsContent value="description" className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 mt-4 space-y-1">
                      <li>Navy and white swirl pattern</li>
                      <li>Sheer navy sleeves</li>
                      <li>Matching belt included</li>
                      <li>Knee-length cut</li>
                      <li>Premium quality fabric</li>
                      <li>Comfortable fit</li>
                      <li>Available in plus sizes 52 and 56</li>
                      <li>Perfect for office and special occasions</li>
                    </ul>
                  </TabsContent>
