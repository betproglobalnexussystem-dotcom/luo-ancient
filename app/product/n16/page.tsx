...
export default function ProductPage() {
  ...
  const product = {
    id: "n16",
    name: "Lime Green Simple Dress",
    price: 60000,
    image: "/images/lime-green-dress.png",
    category: "Women's Dresses",
    productCode: "LGSD-2023",
    description:
      "This vibrant lime green dress is a perfect addition to your casual wardrobe. Simple yet eye-catching, this dress features a comfortable loose fit and high-quality fabric that's perfect for everyday wear. The bright color adds a pop to any outfit and is ideal for the warm Ugandan climate.",
    sizes: ["M", "L", "XL"],
    colors: ["Lime Green"],
    rating: 4.5,
    reviewCount: 18,
            ...
            <div className="lg:w-1/2">
              <div className="glass dark:glass-dark rounded-xl p-6">
                ...
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-sm text-green-600 font-medium">Special Offer</span>
                </div>
                ...
                <Tabs defaultValue="description">
                  ...
                  <TabsContent value="description" className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 mt-4 space-y-1">
                      <li>Vibrant lime green color</li>
                      <li>Comfortable loose fit</li>
                      <li>Soft, breathable fabric</li>
                      <li>Perfect for casual wear</li>
                      <li>Easy to care for</li>
                      <li>Available at French Plaza f36</li>
                      <li>Special price: UGX 60,000</li>
                    </ul>
                  </TabsContent>
