...
export default function ProductPage() {
  ...
  const product = {
    id: "n17",
    name: "Two-Tone Tracksuit Set",
    price: 175000,
    image: "/images/two-tone-tracksuit.png",
    category: "Women's Sportswear",
    productCode: "TTTS-2023",
    description:
      "Stay stylish and comfortable with this trendy two-tone tracksuit set. Available in blue/black and red/black color combinations, this set features a color-block design with black and white stripes. The loose-fitting style provides comfort for everyday wear, while the high-quality fabric ensures durability. Perfect for casual outings, lounging at home, or light physical activities.",
    sizes: ["44", "46"],
    colors: ["Blue/Black", "Red/Black"],
    rating: 4.7,
    reviewCount: 22,
  }
  ...
  const relatedProducts = [
    {
      ...
      price: 165000,
      image: "/images/black-white-tracksuit.png",
      category: "Women's Sportswear",
      productCode: "BWTS-2023",
      isNew: true,
    },
    {
      id: "n19",
      name: "Tommy Hilfiger White Set",
      price: 220000,
      image: "/images/tommy-white-set.png",
      category: "Women's Sportswear",
      productCode: "THWS-2023",
      isNew: true,
    },
    {
      id: "n20",
      name: "Tommy Hilfiger Black Set",
      price: 220000,
      image: "/images/tommy-black-set.png",
      category: "Women's Sportswear",
      productCode: "THBS-2023",
      isNew: true,
    },
  ]
                ...
                <Tabs defaultValue="description">
                  ...
                  <TabsContent value="description" className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 mt-4 space-y-1">
                      <li>Two color options: Blue/Black and Red/Black</li>
                      <li>Color-block design with black and white stripes</li>
                      <li>Comfortable loose fit</li>
                      <li>High-quality cotton blend fabric</li>
                      <li>Elastic waistband with drawstring</li>
                      <li>YLD3 branding</li>
                      <li>Available in sizes 44 and 46</li>
                      <li>Perfect for casual wear and light activities</li>
                    </ul>
                  </TabsContent>
