...
export default function ProductPage() {
  ...
  const product = {
    ...
    description:
      "Elevate your casual style with this premium Burberry-inspired blue set. This matching set features a light blue t-shirt and shorts with the iconic check pattern trim on the sleeves and hem. Crafted from high-quality cotton blend fabric for exceptional comfort and durability. The set includes a matching cap to complete the look.",
    sizes: ["S", "M", "L", "XL", "XXL"],
    colors: ["Light Blue"],
    rating: 4.9,
    reviewCount: 32,
                ...
                <Tabs defaultValue="description">
                  ...
                  <TabsContent value="description" className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-5 mt-4 space-y-1">
                      <li>Premium cotton blend fabric (95% cotton, 5% elastane)</li>
                      <li>Iconic check pattern trim on sleeves and shorts</li>
                      <li>Matching cap included</li>
