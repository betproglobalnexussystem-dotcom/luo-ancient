...
export default function ProductPage() {
  ...
  const product = {
    ...
    description:
      "Make a bold fashion statement with this stunning multicolor maxi dress. Featuring vibrant pink, blue, and green hues in a beautiful abstract pattern, this dress is designed to turn heads. The elegant ruffled collar and flowing silhouette create a flattering look, while the gold belt cinches the waist for a defined silhouette. Perfect for special occasions, parties, or whenever you want to make an impression.",
    sizes: ["M", "L", "XL", "XXL"],
    colors: ["Multicolor"],
    rating: 4.9,
    reviewCount: 36,
